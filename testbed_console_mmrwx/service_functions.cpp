...
// 		display_name[0] = 0;
	...
	/*  */
	bool ServiceManager :: set_names(LPCTSTR driverName, LPCTSTR driverBinPath){
...
// 					!_tcscpy_s(display_name, driverName) && !_tcscat_s(display_name, TEXT("_display_name")) &&
	...
	/*  */
	bool ServiceManager::send_ctrl_code(const DWORD ctrlCode, LPVOID inBuf, DWORD inBufSize, LPVOID outBuf, DWORD outBufSize, LPOVERLAPPED lpOverlapped ){
	...
	bool ServiceManager :: double_check_status(){
		bool b_res = false;
